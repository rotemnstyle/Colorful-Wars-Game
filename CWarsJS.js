(function(window) {
  ...
  let Game = {
    ...
    gameOver: function() {
      ...
      this.ctx.font = 'bold 30px Verdana, Geneva, sans-serif';
...
/**The object Player and the Player's prototype**/
  ...
  /**The object Bullet and the Bullet's prototypes**/
  const Bullet = function(x) {  
    this.width = 8;
    this.height = 20;
    this.x = x;
  ...
  /**The object Bullet and the Enemy's prototypes**/
  ...
  /**The object EnemyBullet and the EnemyBullet's prototypes**/
  const EnemyBullet = function(x, y, color) {
    this.width = 8;
    this.height = 20;
    this.x = x;
    this.y = y;
  ...
  /**The object Particle and the Particle's prototypes**/ 
